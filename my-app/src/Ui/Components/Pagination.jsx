...
const Pagination = ({total,current,onChange}) => {
  ...
  return (
    <div>
        ...
        <button style={{backgroundColor:'#27005D',color:'white',width:'60px',borderRadius:'7px',marginBottom:'6px'}} disabled={current=== 3} onClick={() => onChange(current + 1)}>Next</button>
